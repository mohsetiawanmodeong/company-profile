                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Ubah Testimonial</h6>
                        ...
                        <div class="card-body">
                            ...
                            <?php foreach ($testimonial as $testi) : ?>
                                <form class="row g-3" method="POST" action="<?= base_url('admin/testimonial/update_testimonial_aksi') ?>" Enctype="Multipart/Form-Data">
                                    <div class="col-md-12 mb-3">
                                        <label for="exampleFormControlInput1">Nama</label>
                                        <input type="hidden" name="id" value="<?php echo $testi->id ?>">
                                        <input class="form-control" id="nama" type="text" placeholder="" name="nama" value="<?php echo $testi->nama ?>"></input>
                                        <?php echo form_error('nama', '<span class="text-small text-danger">', '</span>') ?>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleFormControlInput1">Perusahaan/Status</label>
                                        <input class="form-control" id="company" type="text" placeholder="" name="company" value="<?php echo $testi->company ?>"></input>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" id="rating" type="text" placeholder="" name="rating">
                                            ...
                                            <option <?php if ($testi->rating == "1") : ?> selected="selected" <?php endif; ?> value="1">One star</option>
                                            <option <?php if ($testi->rating == "2") : ?> selected="selected" <?php endif; ?> value="2">Two Stars</option>
                                            <option <?php if ($testi->rating == "3") : ?> selected="selected" <?php endif; ?> value="3">Three stars </option>
                                            <option <?php if ($testi->rating == "4") : ?> selected="selected" <?php endif; ?> value="4">Four stars </option>
                                            <option <?php if ($testi->rating == "5") : ?> selected="selected" <?php endif; ?> value="5">Five stars </option>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="deskripsi" type="text" placeholder="" name="deskripsi" rows="3"><?php echo $testi->deskripsi ?></textarea>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-pie">
                                ...
                                <img id="image" width="100%" height="260px" src="<?php echo base_url() . 'assets/upload/' . $testi->avatar ?>">
