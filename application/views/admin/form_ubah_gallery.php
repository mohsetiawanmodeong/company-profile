        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="h4 mb-0 text-gray-800">Ubah Gallery</h4>
                </div>
                <div class="card-body">
                    <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet" />
                    <?php foreach ($gallery as $img) : ?>
                        <form method="POST" action="<?= base_url('admin/gallery/update_gallery_aksi') ?>" Enctype="Multipart/Form-Data">
                            <label for="exampleFormControlFile1">Gambar</label>
                            <div class="form-group mb-3">
                                <img class="mb-3" height="250px" src="<?php echo base_url() . 'assets/upload/' . $img->gambar ?>">
                                <input type="file" class="form-control-file" name="gambar" id="gambar">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1">Kategori</label>
                                <select class="form-control" id="kategori" type="text" placeholder="" name="kategori">
