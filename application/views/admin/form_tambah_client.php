        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="h4 mb-0 text-gray-800">Form Tambah Client</h4>
                </div>
                <div class="card-body">
                    <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet" />
                    <form method="POST" action="<?= base_url('admin/clients/tambah_client_aksi') ?>" Enctype="Multipart/Form-Data">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1">Nama Client</label>
                            <input class="form-control" id="nama_client" type="text" placeholder="" name="nama_client"></input>
