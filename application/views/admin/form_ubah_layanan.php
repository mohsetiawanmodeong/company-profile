        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="h4 mb-0 text-gray-800">Ubah Layanan</h4>
                </div>
                <div class="card-body">

                    <?php foreach ($layanan as $svc) : ?>
                        <form method="POST" action="<?= base_url('admin/layanan/update_layanan_aksi') ?>">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="nama_layanan" type="text" placeholder="" name="nama_layanan" value="<?php echo $svc->nama_layanan ?>"></input>
                                <?php echo form_error('nama_layanan', '<span class="text-small text-danger">', '</span>') ?>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1">Deskripsi</label>
                                <textarea class="form-control" id="desc" type="text" placeholder="" name="desc" rows="4"><?php echo $svc->desc ?></textarea>
