...
<head>
    ...
    <title>TA MODISTE | ADMINISTRATOR</title>
    ...
    <link href="<?= base_url('assets/back-end/') ?>css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <link href="<?= base_url('assets/back-end/') ?>vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
